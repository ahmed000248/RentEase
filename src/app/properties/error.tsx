...
export default function PropertiesError({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-3xl font-extrabold tracking-tight mb-3">Unable to Load Properties</h1>
      <p className="text-white/60 max-w-md text-sm leading-relaxed mb-8">
        We encountered an issue fetching property listings. Please retry or browse all listings.
      </p>
