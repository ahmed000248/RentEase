...
export default function OwnerPortalError({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-3xl font-extrabold tracking-tight mb-3">Owner Portal Error</h1>
      <p className="text-white/60 max-w-md text-sm leading-relaxed mb-8">
        An error occurred while rendering the owner portal. Please retry or return home.
      </p>
